...
if ispc()
    load('R:\Public\GK_lab\Eric\FMUT_development\testing\EmProb_13subs_Test.GND', '-mat');
elseif ismac()
    load('/Volumes/as-rsch-ncl1$/Public/GK_lab/Eric/FMUT_development/testing/EmProb_13subs_Test.GND', '-mat');
end
